  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          _BotaoAcaoItem(icon: Icons.add,                      label: 'Depositar', isPrimary: true, onTap: () => _mostrarDialogoDeposito(context)),
          const SizedBox(width: 24),
          _BotaoAcaoItem(icon: Icons.trending_up,              label: 'Comprar',   onTap: () {}),
          const SizedBox(width: 24),
          _BotaoAcaoItem(icon: Icons.account_balance_outlined, label: 'Vender',    onTap: () {}),
          const SizedBox(width: 24),
          _BotaoAcaoItem(icon: Icons.receipt_long_outlined,    label: 'Extrato',   onTap: () {}),
        ],
      ),
    );
  }
