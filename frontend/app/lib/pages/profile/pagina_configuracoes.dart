...
/// [PaginaConfiguracoes] é a tela onde o usuário pode gerenciar sua conta.
/// 
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const TituloSecao(title: 'Dados da Conta'),
            GrupoConfiguracoes(
              children: [
                TileConfiguracao(
            ...
            // --- SEÇÃO: SEGURANÇA ---
            const TituloSecao(title: 'Segurança e Privacidade'),
            GrupoConfiguracoes(
              children: [
                TileConfiguracao(
